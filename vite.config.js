...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/get_config': 'http://localhost:5000',
      '/upload': 'http://localhost:5000',
      '/get_dataset_header': 'http://localhost:5000',
      '/append_file_to_dataset': 'http://localhost:5000',
      '/apply_filters': 'http://localhost:5000',
      '/get_plot_data': 'http://localhost:5000',
      '/get_lightcurve': 'http://localhost:5000',
      '/get_divided_lightcurves_from_colors': 'http://localhost:5000',
      '/get_joined_lightcurves': 'http://localhost:5000',
      '/get_divided_lightcurve_ds': 'http://localhost:5000',
      '/get_dataset_schema': 'http://localhost:5000'
    }
  },
