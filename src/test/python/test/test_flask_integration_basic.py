...
class TestBasicIntegration:
    ...
    def test_config_endpoints(self, client):
        ...
        # Clear cache
        response = client.post("/clear_cache", data={}, content_type="application/json")
        assert response.status_code == 200
    ...
    def test_lightcurve_basic(self, client, uploaded_file_id):
        ...
        if not time_col or not value_col:
            pytest.skip(
                f"No suitable columns found for lightcurve. Available: {list(events_table.keys())}"
            )
    ...
    def test_plot_data_from_models(self, client):
        ...
        params = {
            "models": [{"type": "PowerLaw", "params": {"amplitude": 1.0, "index": 2.0}}],
...
class TestEdgeCasesBasic:
    ...
    def test_empty_json_body(self, client):
        ...
        response = client.post("/get_lightcurve", data="{}", content_type="application/json")
    ...
    def test_wrong_content_type(self, client):
        ...
        response = client.post("/get_lightcurve", data="some data", content_type="text/plain")
