  ...
  makers: [
    {
      ...
      config: {
        ...
        exe: 'dave.exe',
        description: 'Data Analysis of Variable Events - Astronomical X-ray data analysis',
    ...
    },
    {
      ...
      config: {
        options: {
          ...
          description: 'Data Analysis of Variable Events - Astronomical X-ray data analysis',
          productDescription: 'A desktop GUI application for astronomical X-ray data analysis built on the Stingray library',
        ...
        contents: [
          {
            ...
            y: 220,
            type: 'file',
            path: path.join(__dirname, '../../../../out/DAVE-darwin-x64/DAVE.app'),
          },
          {
            x: 460,
            y: 220,
    ...
    },
    {
      ...
      config: {
        name: 'dave',
        summary: 'Data Analysis of Variable Events',
        description: 'A desktop GUI application for astronomical X-ray data analysis built on the Stingray library',
        grade: 'stable',
        confinement: 'classic',
        base: 'core22',
        categories: ['Science'],
    ...
    },
    {
      ...
      config: {
        options: {
          ...
          productName: 'DAVE',
          genericName: 'Data Analysis Tool',
          description: 'Data Analysis of Variable Events',
